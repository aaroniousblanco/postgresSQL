-- Practice Exercises Solutions are BELOW
...
from
	...
	from
		project
	left outer join
		project_uses_tech on project.id = project_uses_tech.project_id) as joined
left outer join
	tech on joined.tech_id = tech.id;
...
------DATADUMP FOR EXERCISES IS BELOW-------------
